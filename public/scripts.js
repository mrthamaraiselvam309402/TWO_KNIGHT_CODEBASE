...
h1{color:#dca33e;text-align:center;margin-bottom:4px}
h2{color:#333;border-bottom:2px solid #dca33e;padding-bottom:8px;margin-top:30px}
table{width:100%;border-collapse:collapse;margin:16px 0}
th,td{padding:12px;text-align:left;border-bottom:1px solid #ddd}
th{background:#f5f5f5}
.print-btn{background:#dca33e;color:#000;padding:12px 24px;border:none;border-radius:8px;cursor:pointer;margin:20px 0}
...
<tr><td>Total Monthly Revenue</td><td>₹${totalRevenue.toLocaleString()}</td></tr>
</table>
