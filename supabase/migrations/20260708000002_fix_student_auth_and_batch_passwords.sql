-- Fix student auth: make name-based parent login also respect batch passwords
-- and ensure batch password resets actually persist to the batch_passwords table.
...
BEGIN
    ...
    ELSIF p_user_type = 'student' THEN
        SELECT id, name, email, password_hash, batch_id INTO v_user_record
        FROM students
